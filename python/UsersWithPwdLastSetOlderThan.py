...
if __name__ == '__main__':
    ...
    if args.output_file is None:
        args.output_file = "UsersWithPwdLastSetOlderThan_%d_days_%s.xlsx" % (args.days, args.auth_domain.lower())
    ...
    if not args.quiet:
        print("[>] Extracting all users with password last set more than %d days ..." % args.days)
    ...
    print("[+] Written %d users with pwdLastSet older than %d days to %s" % (row_id, args.days, args.output_file))
